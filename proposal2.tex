...
To date, the Grift compiler \cite{grift} stands as the reference implementation for high-performance, close-to-the-metal gradual typing.
...
An alternative to this approach is Abstracting Gradual Typing (AGT) \cite{10.1145/2914770.2837670}.
...
In this model, the static semantics of the gradual language are elaborated into an intermediate cast calculus and this casts are then compiled into coercions.
