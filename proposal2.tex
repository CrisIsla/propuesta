...
In the example transitivity does not work, because $int$ is not consistent with $bool$, and this is something that the dynamic system should be able to deduce.
