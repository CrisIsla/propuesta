...
This evidence can be stored as a number or a pointer to a structure that contains a larger evidence.
For example, the evidence of a function cannot be stored in a single cell, so its evidence is stored in a tree-like structure where the root node contains the types of the function, the arity and an array with the evidences of each argument and return type.
